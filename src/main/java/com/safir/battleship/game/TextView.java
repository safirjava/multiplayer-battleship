...
public class TextView implements View {
    private static final String ENEMY_RESIGNED_TEXT = "ENEMY RESIGNED - YOU WIN";
    private static final String PLAYER_WON_TEXT = "YOU WIN";
    private static final String PLAYER_LOST_TEXT = "YOU LOSE";
    private static final String PLAYER_RESIGNED_TEXT = "YOU RESIGNED - ENEMY WINS";
    ...
    public void viewBoards(PlayerBoard playerBoard, EnemyBoard enemyBoard) {
        ...
        for(int y = 0; y < enemyBoard.getHeight(); y++) {
            ...
            for(int x = 0; x < enemyBoard.getWidth(); x++) {
                CoordinatesState cellState = enemyBoard.getCellState(new Coordinates(x, y));
            ...
            for(int x = 0; x < playerBoard.getWidth(); x++) {
                CoordinatesState cellState = playerBoard.getCellState(new Coordinates(x, y));
                sb.append(cellStateToString(cellState));
            }
            sb.append("|\n");
        }
    ...
    private String cellStateToString(CoordinatesState state) {
        switch(state) {
            case NOTHING:
                return ". ";
            case MISS:
